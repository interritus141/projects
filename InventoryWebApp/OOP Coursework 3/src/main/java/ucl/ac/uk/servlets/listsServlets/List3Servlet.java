...
@WebServlet("/list3servlet.html")
public class
List3Servlet extends HttpServlet {
    private final ItemList list3Items;
    private String name;

    public List3Servlet() {
        this.list3Items = new ItemList();
        loadFile();
    }
    ...
    public void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        RequestDispatcher dispatch = context.getRequestDispatcher("/ItemLists/itemlist3.jsp");
        dispatch.forward(request, response);
    }


    private void createNewFile(HttpServletRequest request) {
        name = (String) request.getSession().getAttribute("List3");
        System.out.println("Name:" + name);
        try {
            list3Items.saveToFile(name);
        } catch (IOException e) {
    ...
    private void setAttributes(HttpServletRequest request) {
        request.setAttribute("itemName", getListOfItemAttributes(list3Items, "Name"));
        request.setAttribute("itemIndex", getListOfItemAttributes(list3Items, "Index"));
        request.setAttribute("itemDescription", getListOfItemAttributes(list3Items, "Description"));
        request.setAttribute("itemURL", getListOfItemAttributes(list3Items, "URL"));
        request.setAttribute("itemImage", getListOfItemAttributes(list3Items, "Image"));
        request.setAttribute("itemImageURL", getListOfItemAttributes(list3Items, "ImageURL"));
    }
