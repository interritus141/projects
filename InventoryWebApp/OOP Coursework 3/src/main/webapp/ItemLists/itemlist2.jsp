...
<body>
    ...
    <form name="Refresh" method="get" action="${pageContext.request.contextPath}/list2servlet.html">
    ...
    <form name="newItemForm" method="get" action="${pageContext.request.contextPath}/list2servlet.html">
