...
<body>
    ...
    <form name="Refresh" method="get" action="${pageContext.request.contextPath}/list7servlet.html">
    ...
    <form name="newItemForm" method="get" action="${pageContext.request.contextPath}/list7servlet.html">
