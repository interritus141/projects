...
<body>
    ...
    <form name="Refresh" method="get" action="${pageContext.request.contextPath}/list6servlet.html">
    ...
    <form name="newItemForm" method="get" action="${pageContext.request.contextPath}/list6servlet.html">
