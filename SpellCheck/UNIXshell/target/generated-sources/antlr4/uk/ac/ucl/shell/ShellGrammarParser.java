...
public class ShellGrammarParser extends Parser {
	...
	public static final String[] ruleNames = {
		"eof_command", "command", "pipe", "call", "redirection", "argument", "atom", 
		"quoted", "doublequoted"
	};
	...
	public static class FinalExprContext extends Eof_commandContext {
		...
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof ShellGrammarVisitor ) return ((ShellGrammarVisitor<? extends T>)visitor).visitFinalExpr(this);
	...
	public static class CallComContext extends CommandContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof ShellGrammarVisitor ) return ((ShellGrammarVisitor<? extends T>)visitor).visitCallCom(this);
			else return visitor.visitChildren(this);
		}
	}
	public static class SeqComContext extends CommandContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof ShellGrammarVisitor ) return ((ShellGrammarVisitor<? extends T>)visitor).visitSeqCom(this);
			else return visitor.visitChildren(this);
		}
	}
	public static class PipeComContext extends CommandContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof ShellGrammarVisitor ) return ((ShellGrammarVisitor<? extends T>)visitor).visitPipeCom(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class LeftCallContext extends PipeContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof ShellGrammarVisitor ) return ((ShellGrammarVisitor<? extends T>)visitor).visitLeftCall(this);
			else return visitor.visitChildren(this);
		}
	}
	public static class LeftPipeContext extends PipeContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof ShellGrammarVisitor ) return ((ShellGrammarVisitor<? extends T>)visitor).visitLeftPipe(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class InputExprContext extends RedirectionContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof ShellGrammarVisitor ) return ((ShellGrammarVisitor<? extends T>)visitor).visitInputExpr(this);
			else return visitor.visitChildren(this);
		}
	}
	public static class OutputExprContext extends RedirectionContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof ShellGrammarVisitor ) return ((ShellGrammarVisitor<? extends T>)visitor).visitOutputExpr(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class ArgContext extends AtomContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof ShellGrammarVisitor ) return ((ShellGrammarVisitor<? extends T>)visitor).visitArg(this);
			else return visitor.visitChildren(this);
		}
	}
	public static class RedirContext extends AtomContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof ShellGrammarVisitor ) return ((ShellGrammarVisitor<? extends T>)visitor).visitRedir(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class SinglequoteContext extends QuotedContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof ShellGrammarVisitor ) return ((ShellGrammarVisitor<? extends T>)visitor).visitSinglequote(this);
			else return visitor.visitChildren(this);
		}
	}
	public static class BackquoteContext extends QuotedContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof ShellGrammarVisitor ) return ((ShellGrammarVisitor<? extends T>)visitor).visitBackquote(this);
			else return visitor.visitChildren(this);
		}
	}
	public static class DoublequoteContext extends QuotedContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof ShellGrammarVisitor ) return ((ShellGrammarVisitor<? extends T>)visitor).visitDoublequote(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class DoublequotedContext extends ParserRuleContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof ShellGrammarVisitor ) return ((ShellGrammarVisitor<? extends T>)visitor).visitDoublequoted(this);
			else return visitor.visitChildren(this);
		}
	}
