...
<body>
    ...
    <form name="Refresh" method="get" action="${pageContext.request.contextPath}/list1servlet.html">
    ...
    <form name="newItemForm" method="get" action="${pageContext.request.contextPath}/list1servlet.html">
